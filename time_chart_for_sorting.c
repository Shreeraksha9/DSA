...
void display(struct node * head,int n)
{
   ...
   //splitting the linked list into 100's group and sorting them//
    ...
    fprintf(fp6,"Time taken to sort %d group is\t\t\t\t\t\t",100*(p-(p-j)));
    fprintf(fp6,"%lf\n",time_taken5);
    ...
    fprintf(fp6,"Time taken to sort the remaining %d group is\t\t\t\t",p1);
    fprintf(fp6,"%lf\n",time_taken3);
